...
static void prepFunctions(std::vector<te_variable> *vars, ShaderSource *filter)
{
	std::vector<te_variable> filter_funcs = {
		...
		{"mel_from_hz", &audio_mel_from_hz, TE_FUNCTION1 | TE_FLAG_PURE, nullptr},
		...
		{"radians", &hlsl_rad, TE_FUNCTION1 | TE_FLAG_PURE, nullptr},
		{"random", random_double, TE_FUNCTION2, nullptr},
		...
		{"screen_height", static_cast<double(*)(double)>(&getScreenHeight), TE_FUNCTION1, nullptr},
