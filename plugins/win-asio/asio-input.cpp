...
//
//ASIOAudioIODevice test;
/* ========================================================================== */
/*          conversions between juce and obs and utility functions       */
/* ========================================================================== */

//enum audio_format asio_to_obs_audio_format(ASIOSampleType format)
//{
//	switch (format) {
//	case ASIOSTInt16LSB:
...
//ASIOSampleType obs_to_asio_audio_format(audio_format format)
//{
//	switch (format) {
//
