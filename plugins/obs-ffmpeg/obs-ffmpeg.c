...
// extern struct obs_output_info  srt_ffmpeg_output;
extern struct obs_output_info  ffmpeg_muxer;
extern struct obs_output_info  replay_buffer;
extern struct obs_output_info  srt_muxer;
...
//	obs_register_output(&srt_ffmpeg_output);
	obs_register_output(&ffmpeg_muxer);
	obs_register_output(&replay_buffer);
	obs_register_output(&srt_muxer);
